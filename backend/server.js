...
// const { Resend } = require('resend'); // <-- Dihapus
// const QRCode = require('qrcode'); // <-- Dihapus
...
// ===== [REVISI] Endpoint update status TIDAK LAGI mengirim email =====
app.post('/update-order-status', async (req, res) => {
    try {
        ...
        // 2. Logika pengiriman email tiket dihapus dari sini
